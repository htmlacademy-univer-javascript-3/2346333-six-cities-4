...
import { fetchNearOffersAction, fetchOfferItemAction, fetchReviewAction } from '../store/offer-data/api-action';
import { useEffect } from 'react';
import { useAppDispatch, useAppSelector } from '../hooks';
import { getIsOfferDataLoading, getNearOffers, getOfferItem, getReviews } from '../store/offer-data/selector';
import { getAuthorizationStatus } from '../store/user-process/selectors';
import { store } from '../store';
import { getSelectedOfferId } from '../store/favorite-data/selector';
          ...
          <div className="offer__container container">
            <div className="offer__wrapper">
              ...
              <section className="offer__map map">
                <Map city={currentOffer.city} coordinates={nearOffers?.map((offer) => offer.city)} selectedPoint={currentOffer.city}/>
              </section>
            </div>
          </div>
        </section>
